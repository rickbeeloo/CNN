...
As can be seen from this data we only classified 249 out of the 362 cancerous examples. We could only classify obivous cancerours examples, as for example this one:
